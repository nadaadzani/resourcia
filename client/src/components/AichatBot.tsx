  ...
  return (
    ...
    >
      <div className="flex rounded-xl p-2 justify-between">
        ...
        >
          <IoMdCloseCircle size={35} className="mx-2 my--20 " />
        </button>
      </div>
        ...
        <div ref={scrollRef} className=" h-full mt-3   overflow-y-auto">
          <ChatMesage
            message={{
              role: "assistant",
              content:
                "Welcome to Resourcia, your sustainable solution for trading food waste! As the official chatbot for Resourcia, I'm here to assist you in turning your food waste into valuable points. How can I help you?",
            }}
          />
          {messages.map((msg) => (
